.. MUD documentation master file, created by
   sphinx-quickstart on Mon Apr  4 23:07:19 2022.
   You can adapt this file completely to your liking, but it should at least
   contain the root `toctree` directive.

Добро Пожаловать в документацию Муд!
======================================
Имеется :ref:`техническая документация <target to paragraph>` для продвинутых пользователей ПК.
...
.. automodule:: Dngn.gamecmd
   :members:

Gameobjects.py:
----------------

.. automodule:: Dngn.gameobjects
   :members:
